...
namespace Engine {
	...
	void Renderer2D::BeginScene(const OrthographicCamera& camera)
	{
		...
		s_Data->FlatColorShader->SetMat4(camera.GetViewProjectionMatrix(),"u_ViewProjection");
	...
	{
		s_Data->FlatColorShader->Bind();
		s_Data->FlatColorShader->SetFloat4(color, "u_Color");

		glm::mat4 transform = glm::translate(glm::mat4(1.0f), position) *
			glm::scale(glm::mat4(1.0f), { size.x,size.y,1.0f });
		s_Data->FlatColorShader->SetMat4(transform, "u_Transform");
